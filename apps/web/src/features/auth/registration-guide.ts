...
export const ACCOUNT_GUIDES: readonly AccountGuide[] = [
...

  {
    ...
    creates:
      'A driver profile. Give your employer’s invite code and it is created inside their fleet; leave the code out and the profile is yours alone until you join one.',
    minutes: 3,
    prepare: [
      {
    ...
    unlocks: [
      'Join your fleet whenever your owner sends you their invite code',
    ...
    questions: [
      ...
      PHOTO_QUESTION,
      {
        ...
        icon: Ticket,
        label: 'Invite code',
        question: 'Do you have your fleet invite code?',
        ...
        example: 'SR-4K9P2M',
        optional: true,
        tip: 'No code yet? Skip this. Your account is created on its own, and your home screen will ask for the code whenever your owner sends it. A code from a business that does not employ drivers is rejected when you finish.',
      },
      {
        id: 'licence',
