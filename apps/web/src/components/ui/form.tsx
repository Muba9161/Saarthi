...
/**
 * react-hook-form bindings that wire accessible labels, descriptions and error
 * messages together automatically, so every form in Saarthi announces its
 * validation state to assistive technology without extra work per field.
 */
