...
dependencies {
    /*
     * The job, shared with the driver app.
     *
     * `:core` exposes its Compose, MapLibre, OkHttp and camera dependencies as
     * `api`, so they arrive here transitively. Re-declaring them would be two
     * places to bump a version and one place to forget.
     */
